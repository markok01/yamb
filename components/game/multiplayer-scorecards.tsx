  ...
  return (
    <div className="flex min-h-0 w-full flex-1 flex-col gap-3">
      {state.scorecards.length > 1 && (
        <div className="player-switcher flex flex-wrap items-center gap-2 rounded-xl border border-[var(--y-border)] bg-[var(--y-surface-elevated)] p-1.5 shadow-[var(--y-shadow-sm)]">
          <span className="px-2 text-[11px] font-medium text-[var(--y-text-muted)]">
            Igrači
          </span>
          <button
            type="button"
            className="player-switcher-active shrink-0 rounded-lg px-3 py-1.5 text-[13px] font-medium"
          >
            Ti
