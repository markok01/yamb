...
const variants: Record<Variant, string> = {
  primary:
    "text-white shadow-lg hover:opacity-95 [background:linear-gradient(135deg,var(--y-accent),var(--y-accent-secondary))] [box-shadow:0_8px_24px_-8px_var(--y-accent-glow)]",
  secondary:
